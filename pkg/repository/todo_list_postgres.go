...
func (r *TodoListPostgres) GetById(userId, id int) (rest_api.TodoList, error) {
...
func (r *TodoListPostgres) Update(userId, id int, input rest_api.UpdateListInput) error {
